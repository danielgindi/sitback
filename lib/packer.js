 ...
 * @property {'git_diff'|'sync'|'xml_replace'|'xml_insert'} mode
                ...
                for (let rule of rules) {
                    ...
                    switch (mode) {
                        ...
                        case 'xml_insert': {
                            ...
                            let section = XmlUtil.extractSection(xmlTree, rule.sourceXmlPath);
                            ...
                            if (section != null || mode === 'xml_replace') {
                                unpackRule.actions.push({
                                    mode: mode.replace(/^xml_/, ''),
                                    path: rule.destXmlPath,
                                    xml: section === null ? null : XmlUtil.stringify(section),
                                });
                            }
                        }
                        break;
